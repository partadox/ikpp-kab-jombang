        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <input type="hidden" value="<?= $tupoksi_pdf ?>" name="tupoksi_pdf_lama">
                    <label for="" class="col-sm-2 col-form-label">Upload</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control" id="tupoksi_pdf" name="tupoksi_pdf" accept=".pdf">
                        <div class="invalid-feedback error_tupoksi_pdf">
...
<script>
    $(document).ready(function() {
        $('.btnupload').click(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= site_url('profil/tupoksi_upload') ?>',
                data: data,
                ...
                success: function(response) {
                    if (response.error) {
                        if (response.error.tupoksi_pdf) {
                            $('#tupoksi_pdf').addClass('is-invalid');
                            $('.error_tupoksi_pdf').html(response.error.tupoksi_pdf);
                        }
                    } else {
                        Swal.fire({
                            title: "Berhasil!",
