...
<div class="modal fade" id="modalupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <br>
            <center>
                <img class="img-thumbnail" width="70%" src="<?= site_url('img/link/thumb/' . 'thumb_' . $list['link_gambar']) ?>" alt="gambar link">
            </center>
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="file" class="form-control" id="link_gambar" name="link_gambar" accept=".jpg,.jpeg,.png">
                        <div class="invalid-feedback error_link_gambar">
                        </div>
                    </div>
                </div>
        ...
        $('.btnupload').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        if (response.error.link_gambar) {
                            $('#link_gambar').addClass('is-invalid');
                            $('.error_link_gambar').html(response.error.link_gambar);
                        }
                    } else {
                        Swal.fire({
                            title: "Berhasil!",
