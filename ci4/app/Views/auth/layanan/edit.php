...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open('layanan/update', ['class' => 'formlayanan']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" class="form-control" id="layanan_id" value="<?= $layanan_id ?>" name="layanan_id" readonly>
                
                <div class="form-group">
                    <label>Kategori Layanan </label>
                    <select name="layanan_kategori" id="layanan_kategori" class="form-control">
                        <?php foreach ($list_kategori as $key => $data) { ?>
                            <option value="<?= $data['LK_id'] ?>" <?php if ($data['LK_id'] == $layanan_kategori) echo "selected"; ?>><?= $data['LK_nama'] ?></option>
                        <?php } ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="layanan_subkategori" name="layanan_subkategori" value="<?= $layanan_subkategori ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="layanan_deskripsi" name="layanan_deskripsi"><?= $layanan_deskripsi ?></textarea>
    ...
    $(document).ready(function() {
        ...
        $('.formlayanan').submit(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    layanan_id: $('input#layanan_id').val(),
