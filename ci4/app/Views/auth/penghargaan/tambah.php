...
<div class="modal fade" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open('medfo/simpan_penghargaan', ['class' => 'formtambah']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">

                <div class="form-group">
                    <label>Nama Penghargaan</label>
                    <input type="text" class="form-control" id="penghargaan_nama" name="penghargaan_nama">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="penghargaan_deskripsi" name="penghargaan_deskripsi"></textarea>
